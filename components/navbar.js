    ...
    return `
        ...
        <div id="header_container" class="flex_display">
            ...
            <div id="header_icon_list">
                ...
                <div class="user_details_icon flex_display cursor">
                    <img id="user_icon" src="https://cdn.shopify.com/s/files/1/0057/8938/4802/files/navigation-Icon4.png?v=1655206048" alt="userIcon">
                    <a src="../offerPage.html" class="cursor">
...
let searchQuery = (terms) => {
    ...
    // Not functional because of API        ----------
    localStorage.removeItem("productsData")
    localStorage.setItem("productsData", JSON.stringify(searchData))
    window.location.href = "../productsPage.html"
}
